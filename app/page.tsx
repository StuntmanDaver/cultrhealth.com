      ...
      <section className="relative py-16 md:py-20 px-6 grad-light overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <FAQAccordion items={[
            ...
            { question: 'Is CULTR available in my state?', answer: 'CULTR Health now serves patients in 30 U.S. states and Washington D.C. — Arizona, Colorado, Connecticut, Delaware, Florida, Georgia, Idaho, Iowa, Louisiana, Maine, Maryland, Minnesota, Missouri, Montana, Nevada, New Hampshire, New Jersey, New Mexico, New York, North Dakota, Pennsylvania, Rhode Island, South Dakota, Texas, Utah, Vermont, Washington, Wisconsin, Wyoming, and Washington D.C. Medications can be shipped to all U.S. states except California. If you\'re physically located in one of these states, you\'re eligible to join.' },
          ]} />
