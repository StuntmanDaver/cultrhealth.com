...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      {/* ─── Hero ─── */}
      <section className="relative min-h-[400px] md:min-h-[600px] lg:min-h-[700px] px-6 bg-cultr-forest overflow-hidden flex items-stretch md:items-center">
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full py-16 md:py-20 flex flex-col">
          ...
          <div className="flex flex-row items-center gap-3 mt-auto md:mt-0">
            <Link href="/quiz">
