...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.log(
      `Cron siphox-fulfillment: ${deferred.processed} deferred (${deferred.fulfilled} fulfilled, ${deferred.stillPending} pending), ${retry.retried} retried (${retry.fulfilled} fulfilled, ${retry.permanentlyFailed} failed)`
    )
