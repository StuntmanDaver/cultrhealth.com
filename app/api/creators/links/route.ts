    ...
    if (process.env.NODE_ENV === 'development') {
      return NextResponse.json({
        links: [
          ...
          { id: '3', creator_id: 'dev_creator', slug: 'dev-glp1', destination_path: '/pricing', click_count: 88, conversion_count: 3, active: true, is_default: false, created_at: '2026-01-10T00:00:00Z' },
        ],
      })
    }
