    ...
    await resend.emails.send({
      ...
      html: `
        ...
        <table style="border-collapse:collapse;width:100%;max-width:600px;">
          <tr><td style="padding:8px;font-weight:bold;border:1px solid #eee;">Creator ID</td><td style="padding:8px;border:1px solid #eee;">${escapeHtml(auth.creatorId)}</td></tr>
          <tr><td style="padding:8px;font-weight:bold;border:1px solid #eee;">Email</td><td style="padding:8px;border:1px solid #eee;">${escapeHtml(auth.email || 'N/A')}</td></tr>
          <tr><td style="padding:8px;font-weight:bold;border:1px solid #eee;">Category</td><td style="padding:8px;border:1px solid #eee;">${escapeHtml(category || 'general')}</td></tr>
          <tr><td style="padding:8px;font-weight:bold;border:1px solid #eee;">Subject</td><td style="padding:8px;border:1px solid #eee;">${escapeHtml(subject)}</td></tr>
        </table>
        <h3>Message</h3>
