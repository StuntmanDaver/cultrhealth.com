      ...
      <section className="pt-16 pb-12 md:pt-20 md:pb-14 px-6 grad-dark-glow text-white">
        <div className="max-w-4xl mx-auto text-center">
          <ScrollReveal direction="none" duration={800}>
            <h2 className="font-display font-bold text-5xl md:text-6xl lg:text-7xl text-white mb-1" style={{ fontFamily: "var(--font-display), 'Playfair Display', Georgia, serif" }}>CULTR</h2>
            <p className="text-sm text-white/50 uppercase tracking-widest mb-6">Health</p>
