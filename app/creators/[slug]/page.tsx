    ...
    return (
      <div className="min-h-screen bg-cultr-cream flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-cultr-forest text-white rounded-full text-sm font-medium hover:bg-cultr-forestDark transition-colors"
          >
            Visit CULTR Health <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </div>
    )
      ...
      <div className="max-w-2xl mx-auto px-4 -mt-6">
        ...
        {creator.defaultCode && (
          <div className="bg-white border border-stone-200 rounded-2xl p-6 shadow-sm mb-6">
            <div className="text-center">
              ...
              <div className="inline-flex items-center gap-3 px-6 py-3 bg-cultr-mint rounded-xl">
        ...
        <div className="space-y-3 mb-8">
          <Link
            ...
            className="flex items-center justify-between p-4 bg-cultr-forest text-white rounded-2xl hover:bg-cultr-forestDark transition-colors group"
          >
            <div>
