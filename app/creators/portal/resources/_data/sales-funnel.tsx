  ...
  'lead-magnets': {
    ...
    content: () => (
      <>
        ...
        <CopyBlock label="Example Quiz Hook">{`"How metabolically healthy are you REALLY? Take this 2-minute quiz to find out — then see how your score compares to 33 actual biomarkers."
...
CTA BUTTON: "Get Started" → [YOUR LINK]`}</CopyBlock>
        ...
        <CopyBlock label="Template">{`HEADING: "Your health has a story. 33 biomarkers will tell it."
...
P.S. Hit reply and tell me — what's your #1 health goal right now?`}</CopyBlock>
        ...
        <CopyBlock label="Subject: 33 biomarkers. Here's what they test.">{`[Walk through what comprehensive testing actually includes. Make it tangible and impressive without being overwhelming.]`}</CopyBlock>
