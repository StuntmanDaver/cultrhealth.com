    ...
    content: () => (
      <>
        ...
        <BulletList items={[
          ...
          'CTA at the end: "Want to know your REAL metabolic markers? CULTR tests 29 biomarkers (upgradeable up to 60+) → [LINK]"',
          'Best for: Weight Loss Seekers, Busy Professionals',
        ]} />

        <CopyBlock label="Example Quiz Hook">{`"How metabolically healthy are you REALLY? Take this 2-minute quiz to find out — then see how your score compares to 29 actual biomarkers."
...
- "29 biomarkers (upgradeable up to 60+). Licensed providers. Personalized protocols."
...
KEY DIFFERENTIATORS:
- 29 biomarkers, upgradeable up to 60+ (vs. the 5-10 your doctor tests)
...
- "29 biomarkers tested per panel (upgradeable up to 60+)"
...
CTA BUTTON: "Get Started" → [YOUR LINK]`}</CopyBlock>
        ...
        <CopyBlock label="Template">{`HEADING: "Your health has a story. 29 biomarkers will tell it."
...
P.S. Hit reply and tell me — what's your #1 health goal right now?`}</CopyBlock>
        ...
        <CopyBlock label="Subject: 29 biomarkers. Here's what they test.">{`[Walk through what comprehensive testing actually includes. Make it tangible and impressive without being overwhelming.]`}</CopyBlock>
        ...
        <CopyBlock label="Subject: Last chance for [discount]">{`[Final email with clear CTA. Summarize the value: "29 biomarkers (upgradeable up to 60+) + licensed provider + personalized protocol from $149/mo." Discount code expires soon. FTC disclosure.]`}</CopyBlock>
