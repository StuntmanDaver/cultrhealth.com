  ...
  'compliance-safe-claims': {
    ...
    content: () => (
      <>
        ...
        <CopyBlock label="Claim 1 — The Data Advantage">{`"Your doctor tests 5 markers. CULTR tests 29 (upgradeable up to 60+). That's the difference between 'you're fine' and actually knowing what's going on."
...
"I stopped guessing about my health and started testing. Here's what changed."`}</CopyBlock>
        ...
        <CopyBlock>{`"I got 29 biomarkers tested through CULTR — here are the 3 things that surprised me."
...
Proof: "My doctor tested 5 markers and said I was fine. CULTR tested 29 and found [X]. Both are valuable — they just serve different purposes."`}</CopyBlock>
