  ...
  'core-programs': {
    ...
    content: () => (
      <>
        ...
        <BulletList items={[
          'Comprehensive metabolic lab panel (29 biomarkers, upgradeable up to 60+)',
...
→ "Recovery is the limiting factor for most athletes — this addresses it directly."`}</CopyBlock>
        ...
        <SubHeading>What&apos;s Included</SubHeading>
        <BulletList items={[
          'Comprehensive longevity panel (29 biomarkers, upgradeable up to 60+, including hs-CRP, homocysteine, insulin, full hormone profile)',
