    ...
    content: () => (
      <>
        ...
        <BulletList items={[
          ...
          'What 33 biomarkers reveal that a standard panel misses',
    ...
    content: () => (
      <>
        ...
        <BulletList items={[
          ...
          'The 33 biomarkers CULTR tests (and what each category reveals)',
...
TRUTH: Without labs, you're guessing which supplements you need. Most people are taking things they don't need while missing actual deficiencies.`}</CopyBlock>
        ...
        <SectionHeading>CTA Variants for This Pillar</SectionHeading>
        <CopyBlock>{`→ "You can't optimize what you don't measure. Get your 33 biomarker panel (SiPhox Health): [LINK]"
...
→ "Brain fog isn't normal. Find out what's causing it with 33 biomarker testing (SiPhox Health): [LINK]"
