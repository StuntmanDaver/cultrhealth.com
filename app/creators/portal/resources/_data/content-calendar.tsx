    ...
    content: () => (
      <>
        ...
        <DataTable
          ...
          rows={[
            ['1', 'Why I got 29 biomarkers tested', 'Longevity', 'Reel / TikTok'],
            ['2', 'Your doctor tests 5 markers. CULTR tests 29.', 'Longevity', 'Carousel'],
      ...
      <>
        ...
        <DataTable
          ...
          rows={[
            ...
            ['3', 'My Lab Results Walkthrough (29 Biomarkers)', 'YouTube', 'Longevity'],
