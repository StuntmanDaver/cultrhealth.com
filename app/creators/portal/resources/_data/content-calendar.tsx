    ...
    content: () => (
      <>
        ...
        <DataTable
          ...
          rows={[
            ['1', 'Why I got 33 biomarkers tested', 'Longevity', 'Reel / TikTok'],
            ['2', 'Your doctor tests 5 markers. CULTR tests 33.', 'Longevity', 'Carousel'],
      ...
      <>
        ...
        <DataTable
          ...
          rows={[
            ...
            ['3', 'My Lab Results Walkthrough (33 Biomarkers)', 'YouTube', 'Longevity'],
