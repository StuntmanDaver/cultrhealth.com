  ...
  'approved-claims': {
    ...
    content: () => (
      <>
        ...
        <CopyBlock label="About CULTR's Services">{`\u2705 "CULTR tests 29 biomarkers (upgradeable up to 60+)"
...
\u274C "Treats depression or anxiety"`}</CopyBlock>
        ...
        <Paragraph>When a peptide or compound is trending on social media (e.g., &quot;What is PT-141?&quot; or &quot;Is SEMA/B6 safe?&quot;), use this 4-step template to discuss it compliantly:</Paragraph>
