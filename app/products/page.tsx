...
export default function ProductsPage() {
  return (
    <div className="flex flex-col">
            ...
            {PRODUCTS.map((product, i) => {
              ...
              return (
                <ScrollReveal key={product.slug} delay={i * 100} direction="up">
                  <div className="p-8 rounded-2xl grad-light border border-cultr-sage hover:border-cultr-forest/40 transition-colors h-full">
                    {product.isBestseller && (
                      <span className="inline-block text-xs font-bold text-cultr-forest tracking-widest grad-mint px-3 py-1 rounded-full mb-4">
                        BESTSELLER
                      </span>
                    )}
                    <div className="flex items-start gap-4 mb-6">
                      <div className="w-14 h-14 rounded-xl grad-dark flex items-center justify-center shrink-0">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <ScrollReveal direction="none" className="order-2 lg:order-1">
              <div className="grad-light rounded-2xl p-8 border border-cultr-sage">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 bg-white rounded-xl border border-cultr-sage">
                      ...
                      <div className="font-medium text-cultr-text">TIRZ/B3</div>
                    </div>
                    <div className="p-4 bg-white rounded-xl border border-cultr-sage">
                  ...
                  <div className="p-4 grad-mint rounded-xl">
            ...
            <ScrollReveal delay={200} direction="none" className="order-1 lg:order-2">
              <div>
                <div className="inline-flex items-center gap-2 grad-mint rounded-full px-4 py-2 mb-6">
                  <Sparkles className="w-4 h-4 text-cultr-forest" />
                ...
                <ul className="space-y-4 mb-8">
                  {[
                    'Analyzes 29 biomarkers, upgradeable up to 60+ (SiPhox EasyDraw Core)',
      ...
      {/* Lab Testing */}
      <section className="py-24 px-6 grad-light">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-cultr-forest mb-4">
      ...
      {/* Safety Note */}
      <section className="py-16 px-6 grad-white border-t border-cultr-sage">
        <div className="max-w-4xl mx-auto">
          <ScrollReveal>
            <div className="flex items-start gap-4 p-6 rounded-xl grad-mint border border-cultr-sage">
