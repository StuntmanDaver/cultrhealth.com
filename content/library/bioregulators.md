# Bioregulators & Neuropeptides

## Overview

Bioregulators are peptides that influence systemic regulatory functions: immune support, sleep optimization, cognitive enhancement, and anti-aging mechanisms. These compounds often work through neuroendocrine pathways.
...
| SELANK | Morning or as needed | Morning/Flexible | Anxiolytic; avoid late evening if sleep-sensitive |
| Humanin | Morning or flexible | Morning/Flexible | Mitochondrial support; morning preferred for energy |
| NAD+ | Morning | Morning | Cellular energy; supports daytime metabolism |
| MOTS-c | Morning or pre-workout | Morning/Pre-Workout | Metabolic/exercise support |
| PT-141 | 30-60 min before desired effect | Flexible/Situational | Sexual function; situational dosing |
| Kisspeptin-10 | 30-60 min before desired effect | Flexible/Situational | GnRH trigger; situational use |

**Key Rules**:
- **Sleep peptides (DSIP)**: 30-60 minutes before bed; do not combine with other sedatives
- **Cognitive peptides (SEMAX, SELANK)**: Morning/early day; avoid late afternoon to prevent sleep disruption
- **Immune peptides (Thymosin-α1)**: Morning consistency; supports daily immune rhythm
...
- **Epitalon**: Generally well-tolerated; effects cumulative
...
- **Humanin**: Emerging compound; more limited data
...
This information is for research and educational purposes only. These compounds are not approved for human use in most jurisdictions. Always consult qualified healthcare providers before considering any compound.
