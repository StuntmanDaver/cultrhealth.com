          ...
          <div className="aspect-square max-w-md mx-auto lg:mx-0 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center p-8">
                <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-cultr-copper/20 flex items-center justify-center">
                  <svg className="w-10 h-10 text-cultr-copper" fill="none" viewBox="0 0 24 24" stroke="currentColor">
