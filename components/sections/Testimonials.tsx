    ...
    <SectionWrapper id="testimonials">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
        {testimonials.map((testimonial, index) => (
          ...
          >
            <div
              className="card hover:border-cultr-copper/50 hover:-translate-y-1 hover:shadow-xl hover:shadow-cultr-copper/10 transition-all duration-300 h-full group"
            >
              {/* Rating */}
              <div className="flex gap-1 mb-4">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <svg 
                    key={i} 
                    className="w-4 h-4 text-cultr-copper transition-transform duration-300" 
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-cultr-copper/20 flex items-center justify-center transition-all duration-300 group-hover:bg-cultr-copper/30 group-hover:scale-110">
        ...
        {visibleTestimonials.map((_, index) => (
          <button
            ...
            className={cn(
              ...
              index === activeIndex ? 'bg-cultr-copper w-4' : 'bg-cultr-lightgray hover:bg-cultr-copper/50'
            )}
