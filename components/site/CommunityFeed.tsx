...
export function CommunityFeed() {
  ...
  return (
    <div>
      ...
      {/* Feed Container */}
      <div className="min-h-[400px] rounded-2xl bg-white border border-cultr-sage/30 p-6 md:p-8">
        {!hasAnyFeed ? (
          /* No feeds configured at all */
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-16 h-16 rounded-full bg-cultr-mint flex items-center justify-center mb-4">
