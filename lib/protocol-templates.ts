...
export const PEPTIDE_CATALOG: CatalogPeptide[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    synergyWith: ['RTA', 'Semaglutide', 'AOD-9604', 'Protein (1.4g/lb)'],
    notes: 'Can be combined with GLP-1 agonists (RTA, semaglutide); requires slow titration for GI tolerance',
  },
  {
    ...
    contraindications: ['Pancreatitis history', 'MTC/MEN2 history', 'Pregnancy', 'Gastroparesis'],
    synergyWith: ['RTA', 'Semaglutide', 'AOD-9604', 'Protein (1.4g/lb)'],
    notes: 'Can be combined with GLP-1 agonists (RTA, semaglutide); larger vial for extended treatment',
  },
  {
    id: 'sema-cagri-blend',
  ...
  },
  {
    ...
    synergyWith: ['RTA', 'Semaglutide', 'Tirzepatide', 'Exercise'],
    notes: 'Can be combined with GLP-1 agonists (RTA, semaglutide) for enhanced weight loss',
  },
  {
    id: 'glp1-semaglutide',
