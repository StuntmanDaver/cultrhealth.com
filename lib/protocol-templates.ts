...
export const SYMPTOM_PROTOCOLS: SymptomProtocol[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    interventions: [
      ...
      { name: 'TIRZ/B3', type: 'peptide', dosageRange: 'Per protocol', timing: 'Weekly', notes: 'Dual incretin appetite support' },
    ],
  ...
  },
  {
    ...
    interventions: [
      ...
      { name: 'Omega-3', type: 'supplement', dosageRange: '2-3g', timing: 'With meals' },
      { name: 'TIRZ/B3', type: 'peptide', dosageRange: 'Per protocol', timing: 'Weekly', notes: 'Appetite normalization' },
    ],
  ...
  },
  {
    ...
    interventions: [
      ...
      { name: 'Inositol', type: 'supplement', dosageRange: '2-4g', timing: 'Before meals' },
      { name: 'Magnesium', type: 'supplement', dosageRange: '300-400mg', timing: 'Evening' },
      { name: 'TIRZ/B3', type: 'peptide', dosageRange: 'Per protocol', timing: 'Weekly', notes: 'Craving reduction' },
    ],
  ...
  },
  {
    ...
    interventions: [
      ...
      { name: 'TIRZ/B3', type: 'peptide', dosageRange: 'Per protocol', timing: 'Weekly', notes: 'Evening appetite support' },
    ],
  ...
  },
  {
    ...
    interventions: [
      ...
      { name: 'Magnesium', type: 'supplement', dosageRange: '400mg', timing: 'Evening' },
      { name: 'Chromium', type: 'supplement', dosageRange: '400mcg', timing: 'With meals' },
      { name: 'TIRZ/B3', type: 'peptide', dosageRange: 'Per protocol', timing: 'Weekly', notes: 'Dual incretin weight management' },
    ],
  ...
  },
  {
    ...
    interventions: [
      ...
      { name: 'TIRZ/B3', type: 'peptide', dosageRange: 'Per protocol', timing: 'Weekly', notes: 'Metabolic support' },
    ],
  ...
  },
  {
    ...
    interventions: [
      ...
      { name: 'TIRZ/B3', type: 'peptide', dosageRange: 'Per protocol', timing: 'Weekly', notes: 'GLP-1/GIP metabolic support' },
    ],
...
export const PEPTIDE_CATALOG: CatalogPeptide[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    synergyWith: ['TIRZ/B3', 'SEMA/B6', 'AOD-9604', 'Protein (1.4g/lb)'],
    notes: 'Can be combined with GLP-1 agonists; requires slow titration for GI tolerance',
  },
  {
    ...
    contraindications: ['Pancreatitis history', 'MTC/MEN2 history', 'Pregnancy', 'Gastroparesis'],
    synergyWith: ['TIRZ/B3', 'SEMA/B6', 'AOD-9604', 'Protein (1.4g/lb)'],
    notes: 'Can be combined with GLP-1 agonists; larger vial for extended treatment',
  },
  {
    id: 'sema-cagri-blend',
  ...
  },
  {
    ...
    synergyWith: ['SEMA/B6', 'TIRZ/B3', 'Exercise'],
    notes: 'Can be combined with GLP-1 agonists for enhanced weight loss',
  },
  {
    id: 'glp1-semaglutide',
    name: 'GLP-1 (SEMA/B6)',
